  ...
  return (
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        ...
        style={{fontFamily:'Raleway', textShadow: ".5px .5px 1px black"}}>
          <i>Con</i>
          <b style={{ fontFamily: "Dancing Script", fontSize: "1.3rem", textShadow: ".5px .5px 1px #991d44" }}>
            Scribe
          </b>
        </Link>
          ...
          <Container>
            <Nav className="mx-auto justify-content-center">
              ...
              >
                ...
                <NavDropdown.Item href="/graphics">Graphics</NavDropdown.Item>
                ...
                <NavDropdown.Item href="/it">Tech Support</NavDropdown.Item>
              </NavDropdown>
            ...
            <Container className="d-flex align-items-center">
              ...
              {isLoggedIn ? (
                ...
                <>
                  <Link to="/login">
                    <button
                      className="rounded bg-dark border border-1 px-2 py-1 shadow"

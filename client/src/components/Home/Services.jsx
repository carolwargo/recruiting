                  ...
                  <div className="container text-center">
                    ...
                    <div className="text-center fw-light w3-padding-large">
                      <h4 className="mb-4 px-4 w3-hide-small w3-hide-medium">
                        EXPLORE OUR KEY OFFERINGS- <br />
                        DISCOVER HOW WE CAN HELP CREATE OR ELEVATE YOUR PERSONAL
                        BRAND & STREAMLINE YOUR MARKETING STRATEGIES.
                      </h4>
                      <h5 className="mb-4 px-4 w3-hide-large">
                        EXPLORE OUR KEY OFFERINGS- DISCOVER HOW WE CAN HELP
                        CREATE OR ELEVATE YOUR PERSONAL BRAND & STREAMLINE YOUR
              ...
              <div className="row px-4 mb-2">
                <div className="col-sm-12 col-md-6 col-lg-6 d-flex mb-2 align-items-start w3-padding-large">
                  ...
                  <div>
                    ...
                    >
                      Create your own dedicated website to showcase your
                      achievements- A platform you control with no limits on how
                ...
                <div className="col-sm-12 col-md-6 col-lg-6 d-flex mb-2 align-items-start w3-padding-large">
                  ...
                  <div>
                    ...
                    >
                      Graphics that enhance your brand, promote a buzz on social
                      media, relay statistics & accolades and more that make a
                      lasting impression.
                    </p>
                    <Link to="/graphics">
                      Get started <FaLongArrowAltRight />
                ...
                <div className="col-sm-12 col-md-6 col-lg-6 d-flex w3-margin-top align-items-start">
                  ...
                  <div>
                    ...
                    >
                      Boost your profile through visibility with one of a kind
                      graphics that that create a buzz, amplify your brand,
                      efficieently communicate accomplishment through visuals.
                    </p>
                    <Link to="/marketing">
                      Get started <FaLongArrowAltRight />
                    </Link>
                ...
                <div className="col-sm-12 col-md-6 col-lg-6 d-flex w3-margin-top align-items-start">
                  ...
                  <div>
                    ...
                    >
                      Showcase your skills through high-quality video content-
                      Providing focused footage coaches want to see, and
      ...
      <div className="w3-container w3-content w3-padding-16">
        <div className=" w3-padding-16">
          <h3 className="text-center">
            Not sure where to start? <Link to="contact">Contact us</Link> with
            questions or schedule a 30-minute{" "}
            <Link to="contact">discovery call</Link> to learn more.
          </h3>
        </div>
      </div>
    </div>

...
const Services = () => {
  ...
  return (
    <div className="services w3-black" id="services">
      ...
      <div>
        <div className="container w3-black">
          ...
          <div className="row d-flex d-flex justify-content-center align-items-center ">
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 shadow d-flex align-items-center justify-content-center">
                  <div className="w3-container w3-padding-small w3-padding-24">
                    ...
                    >
                      Showcase your achievements- A platform you control with no
                      limits on how you highlight your brand.
                    </p>
                    <Link to="/web" className=" link-light">
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 shadow d-flex align-items-center justify-content-center">
                  <div className="w3-container  w3-padding-16">
                    ...
                    >
                      Graphics that elevate your brand, create a buzz, and
                      boldly showcase your drive to go the extra mile.
                    </p>

                    <Link to="/graphics" className="link-light fw-light">
                      Get started <FaLongArrowAltRight />
                    </Link>
                  </div>
                </div>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 shadow d-flex align-items-center justify-content-center">
                  <div className="w3-container  w3-padding-24">
                    ...
                    >
                      Boost your profile, amplify your brand, increase your
                      reach, and drive traffic to your platforms.
                    </p>
                    <Link to="/marketing" className="link-light">
                      Get started <FaLongArrowAltRight />
                    </Link>
                  </div>
                </div>
                ...
                <div className="col-sm-12 col-md-3 col-lg-3 shadow d-flex align-items-center justify-content-center">
                  <div className="w3-container w3-padding-24 ">
                    <h4 className="fw-bold mb-0 fs-5 text-light fw-bold">
                      Video Editing
                    </h4>
                    <p
                      className=" text-light"
...
Showcase your brand with precision: skills videos, highlight reels, and game footage, designed for maximum impact.
                   
                    </p>
                    <Link to="/video" className="link-light">
                      Get started <FaLongArrowAltRight />
                    </Link>
                  </div>
                </div>
    ...
    <p><i>**Services</i></p>
     ...
     <div className="container w3-padding-large">
        <h1
         ...
         <b>   Having trouble with <b>YOUR VISION</b>? Let us help- <br />  Do you have Questions, or not sure where to Start? Contact us for the answers-
         </b>    </p>
         <Link to='/graphics'> 
                    <button className="w3-button w3-white shadow-lg rounded mt-2 mb-3">
                 CONTACT US
                  </button> </Link>  

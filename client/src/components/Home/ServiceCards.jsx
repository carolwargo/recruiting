            ...
            <div className="container py-4">
              ...
              <div className="container mt-4 text-center">
                ...
                <h3 className="mb-4 px-4 w3-hide-small w3-hide-medium">
                  EXPLORE OUR ESSETIAL KEY OFFERINGS- DISCOVER HOW WE CAN HELP
                  CREATE OR ELEVATE YOUR PERSONAL BRAND & STREAMLINE YOUR
                  MARKETING STRATEGIES.
                </h3>
                <h5 className="mb-4 px-4 w3-hide-large">
                  EXPLORE OUR ESSENTIAL KEY OFFERINGS- DISCOVER HOW WE CAN HELP
                  CREATE OR ELEVATE YOUR PERSONAL BRAND & STREAMLINE YOUR
                  MARKETING STRATEGIES.
                </h5>
              ...
              >
                <div className="row w3-hide-small w3-hide-medium">
                  <div
                    ...
                    style={{
                      boxShadow: ".25rem 1rem 10rem rgba(0, 0, 0, 0.75)",
                    }}
                  >
                    {/* Image Container */}
                    <div className="position-relative">

        ...
        {({ inView, ref }) => (
          ...
          >
            <div className="px-4  w3-margin-top w3-margin-bottom text-center">
              ...
              <h3>
                Self-promotion has become an assumed and unavoidable part of the
                recruitment journey, essential for securing opportunities, even
                if it's not what they initially signed up for.
              </h3>
            </div>
                ...
                <div className=" col-sm-12 col-md-6 col-lg-6 d-flex align-items-start">
                  <div>
                    ...
                    <p className=" w3-margin-top">
                      Self-promotion has become an assumed and unavoidable part
                      of the recruitment journey, essential for securing
                      opportunities, even if it's not what they initially signed
                      up for.
                    </p>
                    <p className=" w3-margin-top">

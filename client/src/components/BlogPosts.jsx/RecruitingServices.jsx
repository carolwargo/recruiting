...
const RecruitingServicesPost = () => {
  ...
  color: #ff0000;
   ...
   <h4 className=" w3-text-gray" style={{fontFamily:'Roboto'}}> 
      ...
      <div>
    <h2><span className="w3-text-red w3-hover-text-white">WHY US</span><span className="w3-text-gray">|</span> NOT THEM-</h2>
</div>
...
<h4 className="mt-3">LET'S EXPLORE THE DIFFERENCES, WHY THEY MATTER, AND HOW OUR RECRUIT <span className="w3-text-red text-decoration-underline">ASSISTANCE</span> SERVICES ARE POSITIONED TO PROVIDE THE BEST OUTCOME FOR RECRUITS.</h4>
                </div>
    ...
    Recruiting services often miss the mark BIGGLY, exploiting fear for profit, filled with empty promises. They blatantly undermine what coaches want to see from recruits. YES, WE SAID IT, AND WE STAND BY THE STATEMENT - Those of us who truly understand the inner workings of college athletics know that most coaches cringe and delete when contacted by recruiting services.
        ...
        <h6>WHAT'S THE DIFFERENCE, WHY IT MATTERS, AND HOW WE ARE POSITIONED TO PROVIDE THE BEST OUTCOME FOR RECRUITS.</h6>
        <p className="fw-light mb-1" style={{fontFamily:'Roboto'}}> 
            ...
            <div className="border">
              <div className="w3-padding-large w3-padding-16">
                <div className="card-title">
                  <h4> <b>What Coaches Want</b></h4>
                </div>
                <p>
             Organic & Direct contact with athletes. Third-party involvement is a turn-off, ESPECIALLY if from a recruiter.
                </p>
                <div className="mt-2">
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 d-flex flex-col justify-content-center align-items-center">
            <div className="border">
              <div className="w3-padding-large w3-padding-16">
                ...
                <p>
                Our entire staff has been through the recruiting process- Parents, siblings, former athletes, and current athletes. 
...
export default RecruitingServicesPost;

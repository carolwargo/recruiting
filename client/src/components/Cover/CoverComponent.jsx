  ...
  <header className="mb-auto">
    <div>
      <nav className="nav nav-masthead mb-3 justify-content-center float-md-end">
        <Link to='/' className="nav-link fw-bold py-1 px-0 active" aria-current="page" >Home</Link>
        <Link to='/' className="nav-link fw-bold py-1 px-0">Features</Link>
        <Link to='/' className="nav-link fw-bold py-1 px-0" >Contact</Link>
      </nav>
    </div>
  </header>
